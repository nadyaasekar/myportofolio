...
PORTFOLIO_SECRET_KEY = os.getenv('PORTFOLIO_SECRET_KEY', 'Kayrana2106@')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "nadya-sekar-myportofolio.pws.cs.ui.ac.id"]
...
# Implementasi Form CSRF
CSRF_TRUSTED_ORIGINS = ["https://nadya-sekar-myportofolio.pws.cs.ui.ac.id",
                        "http://localhost:8000",
                        "http://127.0.0.1:8000",]
